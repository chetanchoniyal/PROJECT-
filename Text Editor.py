...
# --------------------------------------WINDOW-CREATION-----------------------------------------------------------------
root = Tk()
root.title("Mystif Text Editor")

root.iconbitmap('iconss/mystif.ico')
...
def about_():
    lbl = messagebox.showinfo("About", "Mystif Text Editor by Chetan Choniyal.")
    lbl.pack()
...
# --------------------------------ICON'S-LIST---------------------------------------------------------------
new_file_icon = PhotoImage(file='iconss/add.png')
open_file_icon = PhotoImage(file='iconss/open.png')
save_file_icon = PhotoImage(file='iconss/save.png')
cut_icon = PhotoImage(file='iconss/cut.png')
copy_icon = PhotoImage(file='iconss/copy.png')
undo_icon = PhotoImage(file='iconss/undo.png')
redo_icon = PhotoImage(file='iconss/redo.png')
find_icon = PhotoImage(file='iconss/find.png')
about_icon = PhotoImage(file='iconss/about.png')
exit_icon = PhotoImage(file='iconss/exit.png')
